# Model definitions were adapted from CellViT: https://github.com/TIO-IKIM/CellViT
...
class TESeg_ResNet50(nn.Module):
    def __init__(self):
        super(TESeg_ResNet50, self).__init__()
        ...
        self.out_binary_mask  = outconv(256, 1)
        self.out_ellipse_dist = outconv(256, 1)
    ...
    def forward(self, img):
        ...
        pred_binary_mask = self.out_binary_mask(x)
        pred_ellipse_dist = self.out_ellipse_dist(x)

        return pred_binary_mask, pred_ellipse_dist